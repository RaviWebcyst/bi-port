<template>
    <div>
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
            <Header />
          <!--  <notifications group="app" position="top center" width="500"  animation-type="velocity" animation="animation" height="100" v-if="enable == false" style="font-size:22px;" /> -->
            ...
            <div style="position:relative;top:250px;text-align:-webkit-center;overflow:unset;z-index:100">
                ...
                <div class="row">
                    <div class="col-lg-12 position-relative z-index-2">
                        ...
                        <div class="col-md-12 col-12 card-body">
                          <h6 class="mb-0">Referral Link</h6>
                          <p class="text-sm">Copy the link bellow to your registered user.</p>
                          <div class="border-dashed border-1 border-secondary border-radius-md p-3">
                          <div class="d-flex align-items-center">
                          <div class="form-group w-70">
                          <div class="input-group bg-gray-200">
                          <input class="form-control form-control-sm" :value="link" type="text" disabled="" >
                          </div>
                          </div>
                          <button type="button" class="btn btn-sm btn-outline-secondary ms-2 px-3" v-clipboard="value">Copy</button>
                          </div>
                          </div>
                          </div>
                        </div>
                        <div class="row mt-4">
                            ...
                            <div class="col-sm-6">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body p-3">
                                        <ul class="list-group" v-if="wallets.length
                                        > 0">
                                            <li class="list-group-item border-0 justify-content-between ps-0 pb-0 border-radius-lg"
                                                v-for="(wallet, i) in wallets" v-if="i < 5">
                                                <div class="d-flex">
                                                    <div class="d-flex align-items-center">
                                                        <button
                                                            class="btn btn-icon-only btn-rounded  mb-0 me-3 p-3 btn-sm d-flex align-items-center justify-content-center"
                                                            :class="wallet.type == 'credit' ? 'btn-outline-success' : 'btn-outline-danger'"><i
                                                                class="fas fa-arrow-down"
                                                                :class="wallet.type == 'credit' ? 'fas fa-arrow-up' : 'fas fa-arrow-down'"
                                                                aria-hidden="true"></i></button>
                                                        <div class="d-flex flex-column">
                                                            <h6 class="mb-1 text-dark text-sm text-capitalize">
                                                                {{ wallet.transaction_type }}</h6>
                                                            <span class="text-xs">{{ new
                                                                    Date(wallet.created_at).toLocaleString()
                                                            }}</span>
                                                        </div>
                                                    </div>
                                                    <div class="d-flex align-items-center  text-gradient text-sm font-weight-bold ms-auto"
                                                        :class="wallet.type == 'credit' ? 'text-success' : 'text-danger'">
                                          ...
                                          <div class="d-flex align-items-center mt-3">
                                                <a href="javascript:;"
                                                    class="text-success text-sm icon-move-right my-auto" @click="transactions()">See
                                                    more
                                        ...
                                        <div class="table-responsive">
                                            <table class="table align-items-center">
                                                ...
                                                <tbody v-if="directs.length > 0">
                                                    <tr v-for="(direct, i) in directs" v-if="i <= 3">
                                                        <td>{{ direct.name }}</td>
                                                        <td>{{ direct.uid }}</td>
                                                        <td>{{ direct.email }}</td>
                                                        <td>{{ direct.enable == 1 ? "Active" : "Inactive" }}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            <div class="d-flex align-items-center mt-3">
                                                <a href="javascript:;"
                                                    class="text-success text-sm icon-move-right my-auto" @click="direct()">See
                                                    more
                                                    <i class="fas fa-arrow-right text-xs ms-1" aria-hidden="true"></i>
                                                </a>
                                            </div>
                ...
                <div class="row mt-4">
                        ...
                        <div class="card z-index-2">
                            <div class="card-body p-3">
                                <div class="bg-gradient-dark border-radius-lg py-3 pe-1 mb-3">
                                    <div class="chart">
                                        <canvas id="chart-bars" class="chart-canvas" height="255" style="
                                                display: block;
                    ...
                    <!-- <div class="col-lg-7">
                        <div class="card z-index-2">
                            ...
                            <div class="card-body p-3">
                                <div class="chart">
                                    <canvas id="chart-line" class="chart-canvas" height="450" width="775" style="
                                            display: block;
                                            box-sizing: border-box;
                                            height: 300px;
                                            width: 516.8px;
                ...
                <div class="row img-row" >
                    <div class="col-12">
                        <div id="globe" class=" peekaboo">
                            <canvas class="me-lg-0 me-n10 mt-lg-5 img-h"
                                ></canvas>
                        </div>
                    </div>
                </div>
...
export default {
        ...
        axios
            ...
            .then((res) => {
                ...
                console.log(res);
                  ...
                  if(res.data.user.enable == 0){
                      var text = document.createElement("div");
                      swal({
                        title: "Hi, "+res.data.user.name,
                    ...
                    text.innerHTML = "<div class='text-center'>with <span class='text-danger h1'>$10</span></div>";
                  }
                this.name = res.data.user.name;
                this.uid = res.data.user.uid;
                this.link = "https://bi-port.live/invite/"+res.data.user.uid;
            })
            .catch((err) => {
          		console.log("error");
                console.log(err);
    ...
    value(){
        ...
        direct(){
            ...
            this.$router.push("directMembers");
        },
        transactions(){
          localStorage.setItem("path","/vue/invest_details");
