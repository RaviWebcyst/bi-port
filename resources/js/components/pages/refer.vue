<template>
  <div class="hold-transition register-page" style="background-image: url('/vue/front/uploads/2022/04/vrrvx.png');background-size:contain ;">
