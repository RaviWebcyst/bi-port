...
class CoinPaymentsController extends Controller
{
    public function payment(Request $request){
        ...
        $req = [
            ...
            'address' => "",
            'ipn_url' => "http://mern-stack.live/vue/api/callback"
        ];
      ...
      if ($postdata['status'] == "100") {
          ...
          if ($amount1 >= $amount2) {
              wallet::create([
                  ...
                  "user_id" => $usr->uid,
                  "amount" => $amount2,
                  "description" => "amount is debit from coinpayment",
                  "wallet_type" => "USD",
    ...
    public function CancelWithdraw(){
      include app_path() . '/Http/Controllers/init.php';
      $coin->Setup('4D8ea842e25722a24FdF24fcA940a4d919B5BBD4233b48a55D8B62aeA915C46E', '6570b8a7528506e26c1dc0107ee2754c2d21d2ad636474a259dfa2441bbc4c1c');
      $result = $coin->CancelWithdraw('https://mern-stack.live/vue/api/withdraw_callback','CWGH3LKILSLTQY57ENQRRZXPHZ');
